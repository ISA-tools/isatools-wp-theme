...
ISATabViewer.rendering = {
    ...
    postprocess_assay_records: function (records) {
        for (var assay_index in records) {
            ...
            var technology_type = assay["Study Assay Technology Type"];
            ...
            assay.icon = measurement_type.indexOf("metabolite") >= 0 ? "assay-icon-metabolomics"
                ...
                : measurement_type.indexOf("chemistry") || technology_type.indexOf("chemistry") >= 0 ? "assay-icon-chemistry"
    ...
    render_isatab_from_gist: function (gist_id, placement, options) {
        ...
        $.ajax({
            ...
            success: function (gist) {
                ...
                $("#download-button").html('<a href="https://gist.github.com/' + gist_id + '/download" class="button-green" style="width: 120px">Download ISA-Tab</span>');
            }
        });
    },
...
//                $("#download-button").html('<a href="https://gist.github.com/' + gist_id +'/download" class="button-green" style="width: 120px">Download this study.</span>');
            }
        });
    },
